...
async function loadReviews() {
    try {
        const response = await fetch('https://arcadia-zoo-api.onrender.com/reviews'); // Replace with your API endpoint
...
async function validateReview(id) {
    try {
        await fetch(`https://arcadia-zoo-api.onrender.com/reviews/${id}/validate`, {
            method: 'PATCH',
        });
...
async function invalidateReview(id) {
    try {
        await fetch(`https://arcadia-zoo-api.onrender.com/reviews/${id}/invalidate`, {
            method: 'PATCH',
        });
...
function handleServiceFormSubmit() {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        try {
            await fetch('https://arcadia-zoo-api.onrender.com/services', {
                method: 'POST',
                headers: {

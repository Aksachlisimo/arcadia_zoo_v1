...
async function loadReviews() {
    try {
        const response = await fetch('https://arcadiazooapi.vercel.app/api/reviews'); // Replace with your API endpoint
...
async function validateReview(id) {
    try {
        await fetch(`https://arcadiazooapi.vercel.app/api/reviews/${id}/validate`, {
            method: 'PATCH',
        });
...
async function invalidateReview(id) {
    try {
        await fetch(`https://arcadiazooapi.vercel.app/api/reviews/${id}/invalidate`, {
            method: 'PATCH',
        });
...
function handleServiceFormSubmit() {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        try {
            await fetch('https://arcadiazooapi.vercel.app/api/services', {
                method: 'POST',
                headers: {

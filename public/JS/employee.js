...
async function loadReviews() {
    try {
        const response = await fetch('https://arcadia-zoo-api.onrender.com/api/reviews'); // Replace with your API endpoint
...
async function validateReview(id) {
    try {
        await fetch(`https://arcadia-zoo-api.onrender.com/api/reviews/${id}/validate`, {
            method: 'PATCH',
        });
...
async function invalidateReview(id) {
    try {
        await fetch(`https://arcadia-zoo-api.onrender.com/api/reviews/${id}/invalidate`, {
            method: 'PATCH',
        });
...
function handleServiceFormSubmit() {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        try {
            await fetch('https://arcadia-zoo-api.onrender.com/api/services', {
                method: 'POST',
                headers: {
